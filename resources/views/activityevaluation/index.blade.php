...
@endforeach
@php
($counter > 0 ? $avgrating = $totrating/$counter : '')
@endphp
...
<div id="activity-page-body">
    <div id="activity-results-container">
        ...
        <h1>Activity Average</h1>
         <input id="input-2" name = "rate" class="rating " data-min="0" data-max="5" data-step="0.1" data-show-caption="false" data-show-clear="false" value ="<?php $avgrating ?>" data-readonly="true" data-size ="sm" >
